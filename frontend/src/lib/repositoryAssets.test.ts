...
describe("repository-local YBI site assets", () => {
  it("keeps every required public image inside the repository", () => {
    for (const assetPath of requiredAssetPaths) {
      const filePath = join(repositoryRoot, "frontend", "public", assetPath);
  ...
  it("does not retain YBI runtime image references to managed storage", () => {
    const runtimeFiles = [
      ...
      "frontend/src/components/PublicSiteChrome.tsx",
      "frontend/src/pages/Home.tsx",
      "frontend/src/pages/Gallery.tsx",
      "frontend/src/pages/About.tsx",
      "frontend/src/pages/Programs.tsx",
      "frontend/src/pages/Subpage.tsx",
      "frontend/src/pages/Team.tsx",
      "frontend/src/lib/aboutMedia.ts",
      "frontend/src/lib/homeUpdates.ts",
    ];
  ...
  it("documents accessible alt text and the optimization workflow for every required asset", () => {
    const assetGuide = readFileSync(
      join(repositoryRoot, "frontend", "ybi-source-assets", "README.md"),
      "utf8",
    );
    const optimizer = readFileSync(
      join(repositoryRoot, "backend", "scripts", "optimize-ybi-image.py"),
      "utf8",
    );

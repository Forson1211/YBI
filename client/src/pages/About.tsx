...
export default function About() {
  return <PublicPageShell><main className="public-page about-page">
    ...
    <section id="approach" className="about-story section-cream"><div className="page-width about-story-grid"><div className="about-story-media"><img src={community} alt="YBI participants sharing an intergenerational conversation" /><div><span>Vision</span><strong>Inspire, motivate, and impact developing potential.</strong></div></div><div className="about-story-copy"><p className="reference-eyebrow"><span /> Our approach</p><h2>Learning moves in <span>both directions.</span></h2><p>Our vision is to inspire, motivate, and impact young, aged, and developing potential in leadership, education, and business. Our mission is to provide a platform where people can become responsible leaders who use their capabilities to make a positive difference in the world.</p><a className="reference-text-link" href="/focus-areas">See our focus areas <ArrowRight size={18} /></a></div></div></section>
    ...
    <section className="page-quote-band"><div className="page-width"><img src={publicSpeaking} alt="A participant practicing public speaking with YBI" /><div><p className="reference-eyebrow light"><span /> The invitation</p><h2>Bring your experience.<br /><span>Make room for another person’s beginning.</span></h2><a className="reference-button white-button" href="/join-us">Find your way in <ArrowUpRight size={18} /></a></div></div></section>

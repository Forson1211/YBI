...
export default function About() {
  return <PublicPageShell><main className="public-page about-page">
    ...
    <section className="page-quote-band"><div className="page-width"><img src={publicSpeaking} alt="A participant practicing public speaking with YBI" /><div><p className="reference-eyebrow light"><span /> The invitation</p><h2>Bring your experience.<br /><span>Make room for another person’s beginning.</span></h2><Link className="reference-button white-button" href="/join-us">Find your way in <ArrowUpRight size={18} /></Link></div></div></section>
